    ...
    <div class="row">
        <div class="col-md-6 clear-paddings">
            <div class="structure-1">
                <h2 class="lead">ಶ್ರೀ ಜಯಚಾಮರಾಜೇಂದ್ರ ಗ್ರಂಥರತ್ನಮಾಲಾ ಸಂಗ್ರಹ</h2>
                <ul class="list-inline">
					<li class="small-text">ಶ್ರೀ ಜಯಚಾಮರಾಜೇಂದ್ರ ಗ್ರಂಥರತ್ನಮಾಲಾ ಎಂಬ ನಾಮಾಂಕಿತದಿಂದ ಕನ್ನಡದಲ್ಲಿ ಅರ್ಥಸಹಿತ ಮುದ್ರಿತವಾಗಿರುವ ಋಗ್ವೇದ, ಮಹಾ ಪುರಾಣಗಳು ಮತ್ತು ಇತರ ಗ್ರಂಥಗಳು</li>
					<li><a href="puranagalu"><i class="fa fa-hand-o-right" aria-hidden="true"></i>&nbsp;ಮುಂದೆ</a></li>
                </ul>
            </div>
        </div>
        <div class="col-md-6 clear-paddings">
